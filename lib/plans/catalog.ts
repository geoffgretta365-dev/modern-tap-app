...
export const PLANS: readonly Plan[] = [
  { key: "starter", name: "Starter", monthlyPrice: 9.99, minimumPlaques: 1, maximumPlaques: 5, initialPlaqueDiscountPercent: 5, designChangesPerYear: 1, replacementPlaquesPerYear: 1, support: "Standard Support", description: "For businesses starting with a few plaques.", sortOrder: 1, custom: false },
  { key: "growth", name: "Growth", monthlyPrice: 14.99, minimumPlaques: 6, maximumPlaques: 10, initialPlaqueDiscountPercent: 10, designChangesPerYear: 2, replacementPlaquesPerYear: 1, support: "Standard Support", description: "For businesses connecting more customer touchpoints.", sortOrder: 2, custom: false },
  { key: "pro", name: "Pro", monthlyPrice: 19.99, minimumPlaques: 11, maximumPlaques: 20, initialPlaqueDiscountPercent: 12.5, designChangesPerYear: 4, replacementPlaquesPerYear: 2, support: "Priority Support", description: "For businesses with a larger plaque network.", sortOrder: 3, custom: false },
  { key: "business", name: "Business", monthlyPrice: 24.99, minimumPlaques: 21, maximumPlaques: 30, initialPlaqueDiscountPercent: 15, designChangesPerYear: 6, replacementPlaquesPerYear: 3, support: "Highest Priority Support", description: "For businesses managing plaques at scale.", sortOrder: 4, custom: false },
  { key: "custom", name: "Custom", monthlyPrice: null, minimumPlaques: 31, maximumPlaques: null, initialPlaqueDiscountPercent: null, designChangesPerYear: null, replacementPlaquesPerYear: null, support: "Negotiated support", description: "Pricing, initial plaque discount, design changes, replacements, and support tailored to your business.", sortOrder: 5, custom: true },
